...
\newcommand*{\getTitle}{Performance Modeling of Application Functions on Heterogeneous Resources in Serverless Computing}
\newcommand*{\getTitleGer}{Titel der Abschlussarbeit}
\newcommand*{\getAuthor}{Muthuraman Chidambaram}
\newcommand*{\getDoctype}{Master's Thesis in Informatics}
\newcommand*{\getSupervisor}{Prof. Dr. Michael Gerndt}
\newcommand*{\getAdvisor}{M.Sc. Anshul Jindal}
